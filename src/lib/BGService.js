...
var SETTINGS = {
    common: [
        ...
        { name: 'debug', group: 'application', dataType: 'boolean', inputType: 'toggle', values: ['true', 'false'], defaultValue: 'true' },
    ...
    iOS: [
        ...
        { name: 'activityType', group: 'geolocation', dataType: 'string', inputType: 'input', values: ['Other', 'AutomotiveNavigation', 'Fitness', 'OtherNavigation'], defaultValue: 'OtherNavigation' },
...
var BGService = (function () {
    ...
    BGService.prototype._init = function () {
        this.deviceInfo = {
            model: Device.model,
    ...
    */
    ...
    BGService.prototype.getPlatformSettings = function (group) {
        var settings = [];
        SETTINGS[Device.platform].forEach(function (setting) {
    ...
    */
    BGService.prototype.getState = function (callback) {
        ...
        this.plugin.getState(function (state) {
            ...
            _this.state.params = { device: _this.deviceInfo };
